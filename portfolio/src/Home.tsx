...
<h1 className="text-5xl font-bold">Junior Software Developer</h1>  
...
{/* projects */}
<section>
  <h1 className="text-2xl font-bold text-center  text-gray-800 mb-4">Projects</h1> 
...
{/* experinces */}
<h1 className="text-2xl font-bold text-center text-gray-800 mb-4">Experience</h1>
...
<section className="flex flex-col justify-center items-center m-2 p-2">
    <h1 className="text-2xl font-bold text-center  text-gray-800 mb-4">Tech stack</h1> 
<div className="max-w-lg bg-white rounded-2xl shadow-lg p-6 ">
